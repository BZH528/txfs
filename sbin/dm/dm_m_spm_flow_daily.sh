...
from
    ...
    on t1.statis_day=t2.statis_day and t1.app_id=t2.app_id and t1.uid=t2.uid
...
insert overwrite table txfs_dm.dm_m_spm_flow_daily
select t1.statis_day statis_day,
  ...
  left join uv_count t2
    on t1.statis_day=t2.statis_day and t1.app_id=t2.app_id  and t1.joint_spm_value=t2.joint_spm_value
union all
select t1.statis_day statis_day,
       t1.app_id app_id,
       t1.channel channel,
