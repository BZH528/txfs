...
from
    ...
    on t1.statis_month=t2.statis_month and t1.app_id=t2.app_id and t1.uid=t2.uid and t1.channel=t2.channel
...
insert overwrite table txfs_dm.dm_m_spm_channel_flow_monthly
select t1.statis_month statis_month,
  ...
  left join uv_count t2
    on t1.statis_month=t2.statis_month and t1.app_id=t2.app_id and t1.channel=t2.channel and t1.joint_spm_value=t2.joint_spm_value
