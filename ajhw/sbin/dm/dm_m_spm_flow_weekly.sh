...
from
    ...
    on t1.statis_week=t2.statis_week and t1.app_id=t2.app_id and t1.uid=t2.uid
...
insert overwrite table txfs_dm.dm_m_spm_flow_weekly
select t1.statis_week statis_week,
  ...
  left join uv_count t2
    on t1.statis_week=t2.statis_week and t1.app_id=t2.app_id  and t1.joint_spm_value=t2.joint_spm_value
