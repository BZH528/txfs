...
basepath1=$basepath/../../sbin/dm/dm_m_spm_channel_flow_monthly.sh
basepath2=$basepath/../../sbin/dm/dm_m_spm_flow_monthly.sh

parameter1=$now_day
sh $basepath/../../sbin/util/loop.sh $basepath1 $parameter1 || error_report_and_exit $script_name $? $LINENO
sh $basepath/../../sbin/util/loop.sh $basepath2 $parameter1 || error_report_and_exit $script_name $? $LINENO
